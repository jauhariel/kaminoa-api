...
// Satu file data/data.sqlite untuk semua: users, special_keys, payments.
// Semua runtime state ada di folder data/ — cukup backup folder itu + .env.
...
const DB_FILE = path.join(__dirname, "..", "data", "data.sqlite")
